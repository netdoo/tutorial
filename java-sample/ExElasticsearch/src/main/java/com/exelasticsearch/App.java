package com.exelasticsearch;



import com.fasterxml.jackson.databind.ObjectMapper;
import com.exelasticsearch.domain.Comment;
import com.exelasticsearch.domain.Student;
...
@Configuration
@ComponentScan({"com.exelasticsearch"})
public class App {
    ...
    */
    ...
    public void bulkInsertDocumentObject(List<Student> students) throws Exception {
        ...
        students.forEach(student -> {
            byte []json = null;
            try {
                json = om.writeValueAsBytes(student);
                bulkRequest.add(client.prepareIndex(getIndexName(), getTypeName())
                        .setId(student.getDocId())
                        .setSource(json));
                logger.info("add : " + student.getName());
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
    ...
    /// 조건에 맞는 docuemnt 만 삭제함.
    public void deleteDocumentByQuery() {

        /// age 가 20인 document 만 삭제함.
        DeleteByQueryResponse response = client.prepareDeleteByQuery(getIndexName())
                .setQuery(termQuery("age", "20"))
                .execute()
                .actionGet();
        ...
        if (restStatus == RestStatus.OK) {
            ...
            logger.error("Delete Error : " + restStatus);
        }
    }
...
//            app.deleteIndex();
            ...
            students.add(new Student("10", "Tomas1", "10", "Hello Tomas 2017"));
            students.add(new Student("11", "Tomas2", "20", "Hello Tomas 2017"));
            students.add(new Student("12", "Tomas3", "20", "Hello Tomas 2017"));
            students.add(new Student("13", "Tomas4", "30", "Hello Tomas 2017"));
            students.add(new Student("14", "Tomas5", "30", "Hello Tomas 2017"));
